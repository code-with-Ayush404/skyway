...
export default function TaxiClient({ initialCars = [] }) {
  ...
  const handleEstimateFare = (e) => {
    ...
    setTimeout(() => {
      ...
      setEstimatedFare(fare);
      setIsEstimating(false);
      toast.success(`Fare calculated for a distance of ${simulatedDistance} km!`);
    }, 800);
  };
  ...
  const getWhatsAppLink = (carName, customFare) => {
    ...
    if (carName) {
      text = `Hi, I would like to book ${carName}. Please share availability.`;
    } else {
      text =
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-text-muted text-xs md:text-sm mt-2 leading-relaxed">
                Reliable, punctual, and professional drivers ready to take you anywhere.
              </p>
            </div>
            ...
            <form onSubmit={handleEstimateFare} className="flex flex-col gap-4">
              ...
              {estimatedFare !== null && (
                <div className="bg-white border p-4 rounded-card flex justify-between items-center">
                  <div>
                    <span className="text-xs text-text-muted">Estimated Fare</span>
              ...
              <div className="p-6">
                ...
                <table className="w-full border border-gray-200 text-sm text-gray-600">
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-gray-200 p-3">Extra KM Price</td>
                      <td className="border border-gray-200 p-3">
                        {car.extraKmPrice}
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td className="border border-gray-200 p-3">Extra Hours</td>
                      <td className="border border-gray-200 p-3">
                        {car.extraHours}
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td className="border border-gray-200 p-3">Night Charge</td>
                      <td className="border border-gray-200 p-3">
                        {car.nightCharge}
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td className="border border-gray-200 p-3">Out Station</td>
                      <td className="border border-gray-200 p-3">
                        {car.outStation}
                      </td>
                    </tr>
