      ...
      <div className="flex items-center justify-between pt-2 mt-auto">
        <a
          href={`https://wa.me/919876543210?text=${encodeURIComponent(
            `Hi Skyway Travel, I want to book "${pkg.title}" package. Please share more details.`
          )}`}
          target="_blank"
          rel="noopener noreferrer"
          className="bg-accent-gold hover:bg-accent-gold-lt text-white text-xs font-semibold py-2.5 px-4 rounded-btn flex items-center gap-1 transition-all"
        >
          Book Now
        </a>
